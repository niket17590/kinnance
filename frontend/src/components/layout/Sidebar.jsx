...
const navItems = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: (
          <svg viewBox="0 0 18 18" fill="none" width="18" height="18">
            <path d="M2 14L6 9l4 4 6-8" stroke="currentColor"
      ...
      },
      {
        ...
        icon: (
          <svg viewBox="0 0 18 18" fill="none" width="18" height="18">
            <path d="M2 6h14M2 9.5h9M2 13h6" stroke="currentColor"
      ...
      },
      {
        ...
        icon: (
          <svg viewBox="0 0 18 18" fill="none" width="18" height="18">
            ...
            <path d="M9 6v3.5l2.5 1.5" stroke="currentColor"
              strokeWidth="1.3" strokeLinecap="round"/>
          </svg>
        )
      },
    ...
    items: [
        ...
        icon: (
          <svg viewBox="0 0 18 18" fill="none" width="18" height="18">
            <rect x="3" y="2" width="12" height="14" rx="2"
              stroke="currentColor" strokeWidth="1.3"/>
            <path d="M6 7h6M6 10h4M6 13h2" stroke="currentColor"
      ...
      },
      {
        ...
        icon: (
          <svg viewBox="0 0 18 18" fill="none" width="18" height="18">
            <circle cx="9" cy="9" r="6.5" stroke="currentColor" strokeWidth="1.3"/>
            <path d="M9 6v6M6.5 8.5L9 6l2.5 2.5" stroke="currentColor"
    ...
    items: [
      {
        ...
        icon: (
          <svg viewBox="0 0 18 18" fill="none" width="18" height="18">
            ...
            <path d="M3 16c0-3.3 2.7-6 6-5s6 1.7 6 5"
        ...
        icon: (
          <svg viewBox="0 0 18 18" fill="none" width="18" height="18">
            <rect x="2" y="4.5" width="14" height="10" rx="2"
              stroke="currentColor" strokeWidth="1.3"/>
            <path d="M6 4.5V3.5a1 1 0 011-1h4a1 1 0 011 1v1M2 9h14"
      ...
      },
      {
        ...
        icon: (
          <svg viewBox="0 0 18 18" fill="none" width="18" height="18">
            <path d="M9 3v10M3 10l6 6 6-6" stroke="currentColor"
              strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        )
      },
